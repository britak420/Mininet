...
//!   closing D-0048's DKG half; index-0 disclosure bug fixed by D-0502).
...
//! feature, off by default (D-0503):** an external audit found this crate
...
// Off by default (D-0503): see the crate docs' "legacy-hand-rolled-dkg"
