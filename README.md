...
3. [`docs/DECISION_LOG.md`](docs/DECISION_LOG.md) — *why each choice was made,
   and when it was superseded* (append-only; main sequence `D-0001`–`D-0511`
   (`D-0511`, the PR #333 Codex/CodeQL/dependency-deny remediation batch
   (custody session binding, DKG phantom-index oracle, stealth-address
   identity-key rejection, custody domain/key-reuse/registry-rollback
   fixes), is the newest at the time of this edit; the Mininet Node
