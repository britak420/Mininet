...
3. [`docs/DECISION_LOG.md`](docs/DECISION_LOG.md) — *why each choice was made,
   and when it was superseded* (append-only; main sequence `D-0001`–`D-0487`
   (`D-0487`, the persistent replay guard's durable-commit-before-accept
   ordering and hex-parser panic fix from the PR #327 findings pack
   (F-12), is the newest at the time of this edit; the Mininet Node
