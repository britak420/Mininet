...
3. [`docs/DECISION_LOG.md`](docs/DECISION_LOG.md) — *why each choice was made,
   and when it was superseded* (append-only; main sequence `D-0001`–`D-0490`
   (`D-0490`, publication routing plans renamed off "achieved"/"receipt"
   and `ExecutableTransport` made unforgeable outside its own gate, from
   the PR #327 findings pack (F-15), is the newest at the time of this
   edit; the Mininet Node Appliance deployment profile this line
