...
3. [`docs/DECISION_LOG.md`](docs/DECISION_LOG.md) — *why each choice was made,
   and when it was superseded* (append-only; main sequence `D-0001`–`D-0489`
   (`D-0489`, validator-handshake verification requiring a caller-
   supplied `ValidatorSet` membership check from the PR #327 findings
   pack (F-14), is the newest at the time of this edit; the Mininet Node
