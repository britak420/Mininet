...
3. [`docs/DECISION_LOG.md`](docs/DECISION_LOG.md) — *why each choice was made,
   and when it was superseded* (append-only; main sequence `D-0001`–`D-0481`
   (`D-0481`, witness-service durability and anti-equivocation hardening
   from the PR #327 findings pack, is the newest at the time of this edit;
