...
3. [`docs/DECISION_LOG.md`](docs/DECISION_LOG.md) — *why each choice was made,
   and when it was superseded* (append-only; main sequence `D-0001`–`D-0488`
   (`D-0488`, `CapabilityGrant::validate` requiring a caller-supplied
   resource owner from the PR #327 findings pack (F-13), is the newest
   at the time of this edit; the Mininet Node Appliance deployment
