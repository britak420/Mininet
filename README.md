...
3. [`docs/DECISION_LOG.md`](docs/DECISION_LOG.md) — *why each choice was made,
   and when it was superseded* (append-only; main sequence `D-0001`–`D-0484`
   (`D-0484`, the crash-recovery publish journal's recovered-object
   verification from the PR #327 findings pack (F-09), is the newest at
   the time of this edit; the Mininet Node Appliance deployment profile
   this line previously credited to `D-0439` is `D-0446` — `D-0439` is the
